...
export function PhraseCard({
  ...
  return (
    <div
      ...
      className={`flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-3 p-3 rounded border transition-colors duration-300 cursor-pointer ${isCurrent ? 'border-l-4 border-l-blue-500 bg-blue-50 border-blue-200' : highlighted ? 'bg-blue-50 border-blue-200' : phrase.excluded ? 'bg-gray-100/50 opacity-50' : 'bg-white border-gray-200'}`}
    >
